...
La función debe retornar un objeto con dos propiedades: products que contiene la cadena de texto con los nombres de los
productos respetando el orden en el que llegan separados por comas,
y totalPrice que contiene la suma total de los precios.
...
);//Output: { products: "Smartphone, Laptop", totalPrice: 2000, }
...
); // Output: { products: "Shirt, Pants", totalPrice:150,}
